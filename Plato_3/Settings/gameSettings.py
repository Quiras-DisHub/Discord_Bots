...
if serverNode == "Master":
	firstNameDict = open('/home/one-to-rule-them-all/VIRTUAL/Discord_Bots/Plato_3/Supplement_Data/DICTS/NAMES/first-names.txt', 'r')
	lastNameDict  = open('/home/one-to-rule-them-all/VIRTUAL/Discord_Bots/Plato_3/Supplement_Data/DICTS/NAMES/last-names.txt', 'r')
